...
describe('validateFilePath', () => {
  ...
  it('should reject path traversal with ..', () => {
    expect(() => validateFilePath('../etc/passwd')).toThrow('Path traversal not allowed');
  });
  ...
  it('should reject tilde paths', () => {
    expect(() => validateFilePath('~/secret')).toThrow('Path traversal not allowed');
  });
  ...
  it('should validate allowed prefixes when provided', () => {
    expect(validateFilePath('/data/file.txt', ['/data/'])).toBe('/data/file.txt');
  });
  ...
  it('should accept any of multiple allowed prefixes', () => {
    expect(validateFilePath('/data/file.txt', ['/tmp/', '/data/'])).toBe('/data/file.txt');
    expect(validateFilePath('/tmp/file.txt', ['/tmp/', '/data/'])).toBe('/tmp/file.txt');
  });
