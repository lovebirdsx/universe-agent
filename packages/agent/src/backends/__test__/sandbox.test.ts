  ...
  describe('edit', () => {
    ...
    describe('empty oldString (editing empty files)', () => {
      ...
      it('should write multi-line content to an empty file', async () => {
        ...
        const result = await sandbox.edit('/empty.txt', '', 'line1\nline2\nline3', false);
        expect(result.error).toBeUndefined();
      ...
      it('should reject empty oldString when file has content', async () => {
        ...
        expect(result.error).toBe('oldString must not be empty unless the file is empty');
      });
    });
    ...
    describe('single replacement (replaceAll=false)', () => {
      ...
      it('should replace at the start of the file', async () => {
        ...
        const result = await sandbox.edit('/test.txt', 'Hello', 'Goodbye', false);
        expect(result.error).toBeUndefined();
      ...
      it('should replace the entire file content', async () => {
        ...
        const result = await sandbox.edit('/test.txt', 'old content', 'new content', false);
        expect(result.error).toBeUndefined();
      ...
      it('should handle multi-line replacements', async () => {
        ...
        const result = await sandbox.edit('/test.txt', 'line1\nline2', 'replaced', false);
        expect(result.error).toBeUndefined();
