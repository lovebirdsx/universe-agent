/**
 * Integration tests for the UniverseAgent ACP Server
 *
 * These tests verify the full ACP protocol flow with a real UniverseAgent.
 */
...
// These tests use the actual @universe-agent/agent library but mock the LLM
...
describe('UniverseAgentServer Integration', () => {
  let server: UniverseAgentServer;
  ...
  describe('Session Management', () => {
    it('should create and track sessions', async () => {
      server = new UniverseAgentServer({
        agents: {
          name: 'test-agent',
    ...
    it('should load existing session', async () => {
      ...
      // Try to load it
      const loadResult = await serverAny.handleLoadSession({ sessionId }, mockConn);
