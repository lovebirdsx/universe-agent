/**
 * Type definitions for the UniverseAgent ACP Server
 *
 * This module provides TypeScript type definitions for integrating
 * UniverseAgent with the Agent Client Protocol (ACP).
 */

import type { CreateUniverseAgentParams } from '@universe-agent/agent';

/**
 * Configuration for a UniverseAgent exposed via ACP
 *
 * Extends CreateUniverseAgentParams from @universe-agent/agent with ACP-specific fields.
 * The `name` field is required for ACP session routing.
 */
export interface UniverseAgentConfig extends CreateUniverseAgentParams {
  /**
 ...
 * ```
 */
export type ACPAuthMethod = ACPAuthMethodAgent | ACPAuthMethodEnvVar | ACPAuthMethodTerminal;

/**
 * Server configuration options
 */
export interface UniverseAgentServerOptions {
  /**
   * Agent configuration(s) - can be a single agent or multiple
   */
  agents: UniverseAgentConfig | UniverseAgentConfig[];
