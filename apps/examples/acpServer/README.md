...
This example demonstrates how to run UniverseAgent as an ACP (Agent Client Protocol) server for integration with IDEs like Zed, JetBrains, and other ACP-compatible clients.
...
The UniverseAgent ACP server provides:
